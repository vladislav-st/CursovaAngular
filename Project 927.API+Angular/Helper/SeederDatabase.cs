    ...
    public class SeederDatabase
    {
        ...
        private static void SeedUsers(UserManager<User> userManager, RoleManager<IdentityRole> roleManager)
        {
            ...
            if (roleManager.FindByNameAsync(roleName).Result == null)
            {
                ...
                var resultUserSeller = roleManager.CreateAsync(new IdentityRole
                {
                    Name = "Seller"
                }).Result;
            ...
            string emailSeller = "seller@gmail.com";
            var seller = new User
            {
                Email = emailSeller,
                ...
                Address = "Rivne",
                Age = 18,
                FullName = "Vlad Stetsyuk"
            };

            var resultSeller = userManager.CreateAsync(seller, "Qwerty1-").Result;
            resultSeller = userManager.AddToRoleAsync(seller, "Seller").Result;
